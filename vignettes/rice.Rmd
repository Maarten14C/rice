...
The p3k14c R package[^9] contains over 175,000 radiocarbon dates (!) and is available on github[^10]. The data from this package can be downloaded (around 25 MB) and plotted and browsed as follows:
...
For another "database of databases", have a look at c14bazAAR[^11] which is also on github. For a table of the available databases, type `c14bazAAR::db_info_table`.
