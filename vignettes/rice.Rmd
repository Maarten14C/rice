...
Younger samples will have more C-14 atoms left than older ones, and thus will get higher counts-per-second at the AMS's C-14 detector. Want to hear a 'sonification' of the counts-per-second of C-14 atoms? (The frequency of the tone relates to the counts per second, and the clicks represent the particles crashing into the detector.) 

```{r, eval=FALSE}
radio(0)
radio(45000) # an old sample 
```
